...
# Parsing + Configuration Script – we151 - Rev. A

This **Parsing + Configuration** script is designed for the **we151** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – we151 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **we151** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
